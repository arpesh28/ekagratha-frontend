...
const Register = () => {
  return (
    <main className="min-h-screen container mx-auto items-center w-screen grid grid-cols-5 mt-[-104px]">
      <div className="col-span-3 flex flex-row justify-start items-center relative">
      ...
      <div className="col-span-2 flex justify-between items-center flex-col px-12 w-full ">
        <Form />
        <span
